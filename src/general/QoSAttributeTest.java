...
public class QoSAttributeTest {
	...
	public void test0() {
		...
		assertEquals(attrSum.getAggregatedQoS(composition), 1.5, 0);
		assertEquals(attrProd.getAggregatedQoS(composition), 0.5, 0);
		assertEquals(attrAvg.getAggregatedQoS(composition), 0.75, 0);
	}
